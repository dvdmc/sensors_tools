...
def generate_sheeps_img(num: int) -> tuple:
    ...
    semantic_img = cv2.resize(
        semantic_img, (0, 0), fx=scale, fy=scale, interpolation=cv2.INTER_NEAREST
    )
    semantic_cropped = semantic_img[
...
if __name__ == "__main__":
    ...
    camera_intrinsics = {"fx": 1000, "fy": 1000, "cx": 256, "cy": 256}
